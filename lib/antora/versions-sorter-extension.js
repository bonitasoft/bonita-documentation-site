module.exports.register = function () {
    ...
    this.on('contentClassified', ({contentCatalog}) => {
        ...
        for (const component of contentCatalog.getComponents()) {
            ...
            // TODO use node 14+, see https://github.com/bonitasoft/bonita-documentation-site/issues/268
            // the ?. syntax is not supported in node 12
            ...
            component.versions.forEach(version => version.prerelease && version.prerelease.includes('alpha') ? alphaVersions.push(version) : sortedVersions.push(version))
