...
function usage() {
  ...
  echo "      --type <string>                         If set to 'links-check', use the configuration to let 'htmltest' check links."
  echo "                                              If set to 'local', use html extension in urls to allow local file browsing."
