...
The syntax is described in https://docs.antora.org/antora/2.3/navigation/reference-resources/

TIP: Antora 3 provide a new syntax for referencing attachments. Please use this syntax instead. See https://docs.antora.org/antora/3.0/navigation/reference-resources/
