...
<version> is the name of the branch in which the PR will be merged and <component_name> can be found in the 'antora.xml' file of the required component under the parameter 'name'.
