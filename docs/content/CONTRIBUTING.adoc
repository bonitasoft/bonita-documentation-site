...
TIP: Antora 3 provide a new syntax for referencing attachments. See https://docs.antora.org/antora/3.0/navigation/reference-resources/
Please use this syntax instead: it allows detecting broken references because it uses the `xref` macro.
...
* What is always here:
 ** The icon with a screen and a monkey wrench. https://github.com/bonitasoft/bonita-doc/blob/2021.2/modules/ROOT/assets/images/images/troubleshooting.png[Here is the link] to reference it
