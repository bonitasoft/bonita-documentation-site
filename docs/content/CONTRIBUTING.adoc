...
WARNING: **DO NOT** hard code urls with https://documentation.ofelia.com/xxxx or ../../my-page.adoc, use xref instead
. An
automatic check rejects your Pull Request if you hard code such links.
