...
* we are creating new branches based on the existing ones, then xref:converting-content-markdown-to-asciidoctor.adoc[convert the content from markdown to asciidoctor]
