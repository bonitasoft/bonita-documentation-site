...
Thanks to the scripts link:../scripts/convert_md_to_asciidoc.py[convert_md_to_asciidoc.py], the conversion was done automatically.

From the root old documentation  folder, run the following command
[source,bash]
----
...
.The script will :
[info]
* Sanitize the markdown source file to render it more easy to be convertible.
