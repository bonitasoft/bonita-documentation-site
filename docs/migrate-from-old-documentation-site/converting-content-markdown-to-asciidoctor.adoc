...
* Run the migration
* In the converted content, manually convert the html. For now, we don't have a solution, see https://github.com/bonitasoft/bonitasoft.github.io/issues/40[issue #40]
====
