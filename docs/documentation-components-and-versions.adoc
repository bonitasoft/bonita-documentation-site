...
An action is available (and trigger each night) to propagate documentation changes upwards to avoid you to update all branches.

[.underline]#Example#: We want to merge branches 2021.1 into 2021.2, 2021.2 into 2022.1 ...
